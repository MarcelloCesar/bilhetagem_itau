...
echo "Iniciando service_recomendacoes na porta 81..."
(
  cd app/service_recomendacoes && \
  nohup python -m uvicorn service_recomendacoes:app --host 0.0.0.0 --port 80 --reload --log-level debug > ../../server_logs/service_recomendacoes.log 2>&1 &
)
